...
<header class="navigation fixed-top nav-bg">
    <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="h3 font-weight-bold">
            <a class="navbar-title" href="<?=$view['urlbaseaddr'] ?>"><img src="<?=$view['urlbaseaddr'] ?>img/logo.svg" style="max-width: 70px; margin-right: 15px; margin-bottom: 15px;" />MoodleORM</a>
        </div>
        <!-- /logo -->
